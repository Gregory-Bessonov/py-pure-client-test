...
class HyperSpace(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            shared_effective (int): The effective space contributed by data that is not unique to a specific volume or snapshot, measured in bytes.
            snapshots_effective (int): The effective space contributed by data unique to one or more snapshots, measured in bytes.
            unique_effective (int): The effective space contributed by unique customer data, measured in bytes. Unique data does not include shared space, snapshots, and internal array metadata.
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `HyperSpace`".format(key))
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HyperSpace):
            return False
